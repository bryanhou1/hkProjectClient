...
export const DISPLAY_DESC = {
  ...
  [DB.SAMPLE]: DISPLAY.SAMPLE,
  [DB.ECO_TYPE]: "The type of habitat category",
  [DB.ECO_SUBTYPE]: "The subtype of habitat category",
  [DB.E_VALUE]: "",
  [DB.HIT_RATIO]: "",
  [DB.HIT_LENGTH]: "",
  [DB.IDENTITY]: ""
...
export const MENU_1 = [
  [ARG, [
    ...
    [DISPLAY_LINKS[DB.RANK],DB.RANK, DISPLAY_DESC[DB.RANK]]
  ]],
  [GENOME_TAXONOMY, [
    [DISPLAY_LINKS[DB.GENOME],DB.GENOME, DISPLAY_DESC[DB.GENOME]],
    [DISPLAY_LINKS[DB.ACCESSION],DB.ACCESSION, DISPLAY_DESC[DB.ACCESSION_WG]],
