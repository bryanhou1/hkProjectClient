...
export const BLAST_CRITERIA_ENTRIES = {
  1: {
    DB: [DB.E_VALUE, DB.HIT_RATIO, DB.IDENTITY],
    DISPLAY: [DISPLAY.E_VALUE, DISPLAY.HIT_RATIO, DISPLAY.IDENTITY]
  },
  2: {
    DB: [DB.E_VALUE, DB.HIT_LENGTH, DB.IDENTITY],
    DISPLAY: [DISPLAY.E_VALUE, DISPLAY.HIT_LENGTH, DISPLAY.IDENTITY]
  }
}
